...
export default function LastFmInfo (props) {
    ...
    return (
        ...
        Here's an example of the album method that gathers information based upon the query parameters 
            <br />
            <br />
            <i><h4>http://ws.audioscrobbler.com/2.0/?method=album.search&album=believe&api_key=API_KEY_GOES_HERE&format=json</h4></i>
            <br />
            <br />
        ...
        <br />
        <br />
        <h4> Within different endpoints there are required query parameters and some being for user and authentication features. To learn what parameters are required for the endpoints please go here: <a href='https://www.last.fm/api#getting-started'>Last FM Api Docs</a></h4>
